...
interface IPaymentPreconditionWithData {
    ...
    /// met by the caller.
    function isPaymentAllowed(uint256 paymentRequestId, address payer, address token, address data, uint256 dataId) external returns(bool);
}